...
const renderBootsListCallback = (bootsTableBody) => (boots) => {
    ...
    boots.forEach((boot) => {
      ...
      <td>
        ...
        <span class="increment-boot-icon" onclick="changeBootQuantity(${boot.id}, 'increment', renderBootsListCallback(document.getElementById('bootsTableBody')));">increment</span>
        <span class="decrement-boot-icon" onclick="changeBootQuantity(${boot.id}, 'decrement', renderBootsListCallback(document.getElementById('bootsTableBody')));">decrement</span>
      </td>
    `;
